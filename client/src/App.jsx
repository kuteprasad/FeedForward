...
import WasteDisposal from "./components/dashboard/donor/WasteDisposal.jsx";
function App() {
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="ngoList" element={<NgoRequestBox />} />
        ...
        >
          ...
          <Route path="notifications" element={<Notifications />} />
          <Route path="verifyNgo" element={<NgoVerificationForm />} />
        </Route>
